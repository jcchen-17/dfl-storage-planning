...
class ScenarioPool:
    ...
    def __post_init__(self) -> None:
        ...
        for scenario in self.scenarios:
            scenario.validate()
        shapes = {(scenario.horizon, scenario.num_buses) for scenario in self.scenarios}
        if len(shapes) != 1:
